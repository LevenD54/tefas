              ...
              <tr key={fund.code} className="hover:bg-blue-50/30 transition-colors group">
                <td className="px-4 py-3 whitespace-nowrap sticky left-0 bg-white group-hover:bg-blue-50/30">
                  <div className="flex items-center">
                    <div className="flex-shrink-0 h-8 w-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-700 font-bold text-xs mr-3 border border-blue-200">
                      {fund.code}
                    </div>
                    <div className="max-w-[150px] md:max-w-xs overflow-hidden">
                      <div className="text-sm font-bold text-gray-900">{fund.code}</div>
